...
public:
  ...
  // Effective capacitance (Ceff) used by the most recent DMP evaluation.
  // This is meaningful only after gateDelay/reportGateDelay has been
  // called with a valid parasitic and table model.
  float ceff() const;
